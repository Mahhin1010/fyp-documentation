...
\begin{document}
	...
	% --- 3. INSERT DECLARATION, DEDICATION, ACKNOWLEDGEMENT, PROJECT IN BRIEF, ABSTRACT ---
	\includepdf[pages=4-8]{INITIAL.pdf}
    ...
    \input{chapters/03_usecase}
    \input{chapters/04_construction}
    \input{chapters/05_testing}
    \input{chapters/06_user_guide}
